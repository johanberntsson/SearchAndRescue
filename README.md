...
19 with it unchanged at every step, the last third of that by moving the
per-pixel arithmetic into 45GS02 assembly. A whole world costs about eighty
seconds to build; the game does not fly the result yet.
